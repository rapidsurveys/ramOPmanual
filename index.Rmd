...
colorlinks: TRUE
fontsize: 12pt
url: https\://validmeasures.org/ramOPmanual
github-repo: validmeasures/ramOPmanual
cover-image: figures/coverImage.jpg
description: "Rapid assessment method for older people (RAM-OP) manual"
---

```{r global_options, include = FALSE}
knitr::opts_chunk$set(fig.pos = "H", out.width = "400px", dpi = 120)
```


# The RAM-OP Manual {-}

![](figures/coverImage.jpg)
