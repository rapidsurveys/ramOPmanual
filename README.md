...
[![License for code](https://img.shields.io/badge/license_(for%20code)-GPL3.0-blue)](https://opensource.org/licenses/gpl-3.0.html)
[![License for text](https://img.shields.io/badge/license_(for%20writing)-CC_BY_4.0-blue)](https://creativecommons.org/licenses/by/4.0/)
[![test book render](https://github.com/rapidsurveys/ramOPmanual/actions/workflows/netlify.yaml/badge.svg)](https://github.com/rapidsurveys/ramOPmanual/actions/workflows/netlify.yaml)
[![Quarto Publish](https://github.com/rapidsurveys/ramOPmanual/actions/workflows/publish.yaml/badge.svg)](https://github.com/rapidsurveys/ramOPmanual/actions/workflows/publish.yaml)
[![DOI](https://zenodo.org/badge/1342015.svg)](https://doi.org/10.5281/zenodo.1342015)
<!-- badges: end -->
