...
{\centering \includegraphics[width=10.17in]{figures/popPyramid1} 
...
{\centering \includegraphics[width=9.72in]{figures/popPyramid2} 
...
\item
  ...
  sampled from m = 30 communities giving an expected overall sample size
  of n = 210. This would be a very good sample. The disadvantage of this
  approach is that survey costs increase with the number of communities
  that are sampled, because a lot of survey time and vehicle costs are
  spent on travelling to and from the selected communities.
\item
  ...
  fewer than n = 12 older people is to collect data on all older people
  in the selected community using a door-to-door census. If the
...
{\centering \includegraphics[width=9.86in]{figures/listSample2} 
...
{\centering \includegraphics[width=9.72in]{figures/mapSample1} 
...
{\centering \includegraphics[width=9.72in]{figures/mapSample2} 
...
{\centering \includegraphics[width=9.72in]{figures/mapSample3} 
...
{\centering \includegraphics[width=9.72in]{figures/mapSample4} 
...
{\centering \includegraphics[width=9.72in]{figures/mapSample5} 
