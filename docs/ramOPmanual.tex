...
{\centering \includegraphics[width=800pt]{figures/mapSample4} 
...
{\centering \includegraphics[width=800pt]{figures/stage2sample1} 
...
{\centering \includegraphics[width=800pt]{figures/stage2sample2} 
...
{\centering \includegraphics[width=800pt]{figures/stage2sample3} 
...
{\centering \includegraphics[width=800pt]{figures/stage2sample4} 
...
{\centering \includegraphics[width=800pt]{figures/stage2sample5} 
...
{\centering \includegraphics[width=800pt]{figures/stage2sample6} 
...
{\centering \includegraphics[width=800pt]{figures/stage2sample7} 
...
Visual impairment An indicator of visual impairment is derived from this
questionnaire component: Visual Acuity va1 Do you normally wear glasses?

If the person wears glasses, ask if they are more comfortable wearing
their glasses to look at your chart at 2 meters. Let the person decide.

Demonstrate (close to the person) how to do the `tumbling E' test:
...
before turning it each time. va2a First time 1 = Correct 2 = Incorrect 3
= Refused 4 = Blind \textbar{}\textbf{\textbar{} va2b Second time 1 =
Correct 2 = Incorrect 3 = Refused 4 = Blind \textbar{}}\textbar{} va2c
Third time 1 = Correct 2 = Incorrect 3 = Refused 4 = Blind
\textbar{}\textbf{\textbar{} va2d Fourth time 1 = Correct 2 = Incorrect
3 = Refused 4 = Blind \textbar{}}\textbar{}
...
{\centering \includegraphics[width=800pt]{figures/openProjectRAF} 
...
{\centering \includegraphics[width=800pt]{figures/openWorkflowRAF} 
...
{\centering \includegraphics[width=800pt]{figures/runWorkflowRAF} 
