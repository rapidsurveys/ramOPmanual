...
\toprule
\begin{minipage}[t]{0.97\columnwidth}\centering
\textbf{Anthropometry and screening coverage}\strut
\end{minipage}\tabularnewline
\bottomrule
\end{longtable}

Indicators relating to anthropometry and screening coverage are derived
from this questionnaire component: Anthropometry / Screening Coverage
as1 MUAC in mm 777 = Too large 888 = Refused
