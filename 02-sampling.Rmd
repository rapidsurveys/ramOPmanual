...
Census enumeration areas (EAs) are usually city blocks. Central statistics offices can usually provide lists of EAs by “section” and large-scale maps of EAs selected for sampling (See \@ref(fig:sample25) and \@ref(fig:sample26)). These maps make it easy to locate EAs and their boundaries. The sample of EAs can be decided using list-based or map-based (CSAS) sampling.
...
Larger scale “maps” of blocks to be sampled can also me made using satellite imagery (see \@ref(fig:sample29)).
