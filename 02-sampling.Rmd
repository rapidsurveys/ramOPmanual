...
```{r sample1, echo = FALSE, fig.cap = "Communities listing by district and sub-district", out.width = "80%", fig.align = "center", fig.pos = "H", fig.retina = 1}
...
```{r sample2, echo = FALSE, fig.cap = "Population pyramid for a typical developing country", out.width = "90%", fig.align = "center", fig.pos = "H", fig.retina = 1}
